...
import com.example.raw2.ui.gallery.Main19Activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(final String url, final String userAgent, final String contentDisposition, final String mimetype, long contentLength) {
                ...
                Dexter.withActivity(Main20Activity.this)
                        ...
                        .withListener(new PermissionListener() {
                            ...
                            public void onPermissionGranted(PermissionGrantedResponse response) {
                                ...
                                Toast.makeText(Main20Activity.this, "Downloading file....", Toast.LENGTH_SHORT).show();
